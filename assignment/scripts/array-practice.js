...
let favoriteFoods = ['Meatball Hoagie', 'Salmon', 'Steak', 'Homemade Beef Stew'] ;
...
let dessert = "red velvet cake with ice cream" ;
...
let entree = "breakfast crunchwrap with sausage" ;
...
let Citrine = gems.pop[1] ;
let TopazR = gems.pop[0] ;
...
gems = ['Tourmaline', 'Topaz', 'Tanzanite', 'Iolite', 'Emerald', 'Diamond'] ;
