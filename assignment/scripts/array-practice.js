...
let favoriteFoods = ['Meatball hoagies','Burritos with Barbocoa ','Pasta with Diavolo Sauce and Shrimp','Salmon with Lemon','Spicy Tuna Sushi']
console.log('My top five foods are', favoriteFoods);
...
let dessert = 'Vinilla Ice Cream with Red Velvet Cake or Grandmothers Sugar Cookies';
